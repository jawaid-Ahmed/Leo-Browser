...
import com.jawaid.liobrowser.Activities.HistoryActivity;
...
public class HistoryRecyclerAdapter extends RecyclerView.Adapter<HistoryRecyclerAdapter.HistoryViewHolder> {
    ...
    public HistoryRecyclerAdapter(HistoryActivity historyActivity, List<HistoryModel> histories,OnHorizontalItemClickListener onHItemClickListener) {
