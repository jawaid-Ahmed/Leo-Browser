    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        switch (status) {
            case COMPLETED:
                ...
                //{
//                holder.actionButton.setImageResource(R.drawable.ic_done);
...
//                });
            ...
            case PAUSED: {
                holder.actionButton.setImageResource(R.drawable.ic_play);
            ...
            case DOWNLOADING:
            case QUEUED: {
                holder.actionButton.setImageResource(R.drawable.ic_pause);
                holder.actionButton.setOnClickListener(view -> {
                    holder.actionButton.setEnabled(false);
        ...
        holder.itemView.setOnLongClickListener(v -> {
            ...
            new MaterialAlertDialogBuilder(context, R.style.myAlertDialoge)
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            extensionTextView = itemView.findViewById(R.id.fileExtension);
